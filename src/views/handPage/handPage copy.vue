<template>
    <div class="hand-page-container">
        ...
        <div class="page-header-box">
            <h2 class="page-header-title">Hand Admin账户维护
                <div class="custom-alert-info">请使用Admin账户登陆</div>
            </h2>
        ...
        <div class="page-content-box">
            <div class="env-list-card">
                <div @click="handleSelectEnv(item.value)" v-for="item in envList" :key="item.value"
                    ...
                    <t-tag v-if="selectedEnv === item.value" class="env-list-card-item-tag" shape="mark"
                        theme="primary">当前选中</t-tag>
